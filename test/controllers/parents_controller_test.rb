...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { contact_no: @parent.contact_no, name: @parent.name, saluatation: @parent.saluatation } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { contact_no: @parent.contact_no, name: @parent.name, saluatation: @parent.saluatation } }
